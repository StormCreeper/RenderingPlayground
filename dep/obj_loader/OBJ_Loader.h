...
float MagnitudeV3(const glm::vec3 in) { return glm::length(in); }

// Vector3 DotProduct
float DotV3(const glm::vec3 a, const glm::vec3 b) { return glm::dot(a, b); }
...
bool inTriangle(glm::vec3 point, glm::vec3 tri1, glm::vec3 tri2,
				glm::vec3 tri3) {
