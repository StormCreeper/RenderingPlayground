...
glm::vec3 evaluateRadiance(const Material& mat, const std::shared_ptr<AbstractLight>& source, const glm::vec3& normal, const glm::vec3& wo, const glm::vec3& fPos);

glm::vec3 evaluateTotalRadiance(const Scene& scene, const glm::vec3& fPos, const glm::vec3& fNormal, const Material& material, const glm::vec3& eye);