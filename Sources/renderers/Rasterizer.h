...
private:
    ...
    GLuint genGPUVertexArray(GLuint posVbo, GLuint ibo, bool hasNormals, GLuint normalVbo, bool hasUVs, GLuint uvVBO, bool tangentSpace, GLuint tangentVbo, GLuint bitangentVbo);
