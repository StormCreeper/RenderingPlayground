...
static int rendererID(0); // 0: rasterization, 1: ray tracing, 2: GPU ray tracing
...
void scroll_callback(GLFWwindow* window, double xoffset, double yoffset) {
    scenePtr->camera()->setTranslation(scenePtr->camera()->getTranslation() + meshScale * glm::vec3(0.0, 0.0, -yoffset));
}
...
void initScene() {
    ...
    Material glassMat(glm::vec3(1.0f), 0.1f, 1.0f, glm::vec3(1.0, 1.0, 1.0), true, 0.04f, 1.3f);
    ...
    Material groundMat = { glm::vec3(1.0f), 0.5f, 0.1f, glm::vec3(1.0, 1.0, 1.0) };
    ...
    scenePtr->add(std::make_shared<DirectionalLight>(glm::vec3(0.7f, 0.9f, 0.9f), 4.0f, glm::normalize(glm::vec3(0.04f, -0.544f, -0.838f))));

    glm::vec3 pos1 = center + 1.5f * meshScale * glm::normalize(glm::vec3(-1, 0.5, 0.5));
    glm::vec3 pos2 = center + 1.5f * meshScale * glm::normalize(glm::vec3(1, 0.5, -0.1));
    glm::vec3 pos3 = center + 1.5f * meshScale * glm::normalize(glm::vec3(0.2, 0, -1));

    scenePtr->add(std::make_shared<PointLight>(glm::vec3(1.0f, 0.5f, 0.5f), 4.0f, pos1, 1.0f, 0.0f, 0.2f));
    scenePtr->add(std::make_shared<PointLight>(glm::vec3(0.5f, 1.0f, 0.5f), 4.0f, pos2, 1.0f, 0.0f, 0.2f));
    scenePtr->add(std::make_shared<PointLight>(glm::vec3(0.8f, 0.5f, 1.0f), 4.0f, pos3, 1.0f, 0.0f, 0.2f));

    scenePtr->set(ImageParameters{ true, true, true, true, 0.4f, true, false, 10 });
