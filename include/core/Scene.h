...
class Scene {
   public:
	...
	inline const glm::vec3& backgroundColor() const {
		return m_backgroundColor;
	}

	inline void setBackgroundColor(const glm::vec3& color) {
	...
	inline const std::shared_ptr<Model> model(size_t index) const {
		return m_models[index];
	}

	inline std::shared_ptr<Model> model(size_t index) {
		return m_models[index];
	}

	// Textures

	inline void add(std::shared_ptr<Texture> texture) {
		m_textures.push_back(texture);
	}

	inline size_t numOfTextures() const { return m_textures.size(); }

	inline const std::shared_ptr<Texture> texture(size_t index) const {
		return m_textures[index];
	}

	inline std::shared_ptr<Texture> texture(size_t index) {
		return m_textures[index];
	}

	// Lights

	inline void add(std::shared_ptr<AbstractLight> light) {
		m_lights.push_back(light);
	}

	inline size_t numOfLights() const { return m_lights.size(); }

	inline const std::shared_ptr<AbstractLight> light(size_t index) const {
		return m_lights[index];
	}

	inline std::shared_ptr<AbstractLight> light(size_t index) {
		return m_lights[index];
	}
	...
	inline void replaceLight(size_t index,
	...
	inline void set(const ImageParameters& imageParameters) {
		m_imageParameters = imageParameters;
	}

	inline const ImageParameters& imageParameters() const {
